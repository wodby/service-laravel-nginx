# Nginx (Laravel) service for Wodby

Use Nginx (Laravel) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Nginx (Laravel) service in the Wodby catalog.

- [Nginx (Laravel) service in the Wodby catalog](https://wodby.com/services/laravel-nginx)
...
4. Reference `laravel-nginx` from your stack manifest.
